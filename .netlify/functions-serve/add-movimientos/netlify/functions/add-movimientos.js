...
// node_modules/@netlify/neon/node_modules/@neondatabase/serverless/index.js
var require_serverless = __commonJS({
  "node_modules/@netlify/neon/node_modules/@neondatabase/serverless/index.js"(exports2, module2) {
    "use strict";
    ...
    var co = (r, e, t) => e in r ? Te(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
    ...
    var Pn = (r, e, t, n) => {
      if (e && typeof e == "object" || typeof e == "function") for (let i of oo(e)) !uo.call(r, i) && i !== t && Te(r, i, { get: () => e[i], enumerable: !(n = so(e, i)) || n.enumerable });
      return r;
    };
    var Ie = (r, e, t) => (t = r != null ? io(ao(r)) : {}, Pn(e || !r || !r.__esModule ? Te(t, "default", {
      value: r,
      enumerable: true
    }) : t, r));
    var O = (r) => Pn(Te({}, "__esModule", { value: true }), r);
    ...
    var Rn = I((st) => {
      ...
      st.toByteArray = po;
      st.fromByteArray = go;
      var ue = [], ne = [], ho = typeof Uint8Array < "u" ? Uint8Array : Array, Ft = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
      for (_e = 0, Bn = Ft.length; _e < Bn; ++_e)
        ue[_e] = Ft[_e], ne[Ft.charCodeAt(_e)] = _e;
      var _e, Bn;
      ne[45] = 62;
      ne[95] = 63;
      function Ln(r) {
      ...
      a(fo, "_byteLength");
      function po(r) {
        var e, t = Ln(r), n = t[0], i = t[1], s = new ho(fo(r, n, i)), o = 0, u = i > 0 ? n - 4 : n, c;
        for (c = 0; c < u; c += 4) e = ne[r.charCodeAt(c)] << 18 | ne[r.charCodeAt(c + 1)] << 12 | ne[r.charCodeAt(c + 2)] << 6 | ne[r.charCodeAt(c + 3)], s[o++] = e >> 16 & 255, s[o++] = e >> 8 & 255, s[o++] = e & 255;
        return i === 2 && (e = ne[r.charCodeAt(c)] << 2 | ne[r.charCodeAt(c + 1)] >> 4, s[o++] = e & 255), i === 1 && (e = ne[r.charCodeAt(
          c
        )] << 10 | ne[r.charCodeAt(c + 1)] << 4 | ne[r.charCodeAt(c + 2)] >> 2, s[o++] = e >> 8 & 255, s[o++] = e & 255), s;
      }
      a(po, "toByteArray");
      function yo(r) {
    ...
    var Yn = I((Re) => {
      "use strict";
      p();
      var Dt = Rn(), Be = Fn(), Mn = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
      Re.Buffer = f;
      Re.SlowBuffer = vo;
      ...
      a(Nn, "assertSize");
      function bo(r, e, t) {
        return Nn(r), r <= 0 ? pe(r) : e !== void 0 ? typeof t == "string" ? pe(r).fill(e, t) : pe(r).fill(e) : pe(r);
      }
      a(
        bo,
        "alloc"
      ...
      function So(r, e) {
        ...
        let t = qn(r, e) | 0, n = pe(t), i = n.write(r, e);
        return i !== t && (n = n.slice(0, i)), n;
      }
      a(So, "fromString");
      function kt(r) {
        let e = r.length < 0 ? 0 : qt(r.length) | 0, t = pe(e);
      ...
      function Eo(r) {
        ...
        if (r.length !== void 0)
          return typeof r.length != "number" || jt(r.length) ? pe(0) : kt(r);
        if (r.type === "Buffer" && Array.isArray(r.data)) return kt(r.data);
      }
      a(Eo, "fromObject");
      function qt(r) {
      ...
      f.prototype.toString = a(function() {
        let e = this.length;
        return e === 0 ? "" : arguments.length === 0 ? jn(
          this,
          0,
          e
      ...
      Mn && (f.prototype[Mn] = f.prototype.inspect);
      ...
      function Qn(r, e, t, n, i) {
        ...
        if (typeof e == "string" && (e = f.from(e, n)), f.isBuffer(e)) return e.length === 0 ? -1 : Dn(r, e, t, n, i);
        if (typeof e == "number") return e = e & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(r, e, t) : Uint8Array.prototype.lastIndexOf.call(r, e, t) : Dn(
          r,
          [e],
          t,
          n,
      ...
      function Bo(r, e, t) {
        return e === 0 && t === r.length ? Dt.fromByteArray(r) : Dt.fromByteArray(r.slice(e, t));
      }
      a(Bo, "base64Slice");
      function jn(r, e, t) {
      ...
      function Lo(r) {
        let e = r.length;
        if (e <= kn) return String.fromCharCode.apply(String, r);
        let t = "", n = 0;
        for (; n < e; ) t += String.fromCharCode.apply(String, r.slice(n, n += kn));
        return t;
      }
      ...
      f.prototype.writeBigUInt64LE = ge(a(function(e, t = 0) {
        return Wn(this, e, t, BigInt(0), BigInt(
          "0xffffffffffffffff"
        ));
      }, "writeBigUInt64LE"));
      f.prototype.writeBigUInt64BE = ge(a(function(e, t = 0) {
        return Hn(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"));
      }, "writeBigUInt64BE"));
      ...
      f.prototype.writeBigInt64LE = ge(a(function(e, t = 0) {
        return Wn(this, e, t, -BigInt(
          "0x8000000000000000"
        ), BigInt("0x7fffffffffffffff"));
      }, "writeBigInt64LE"));
      f.prototype.writeBigInt64BE = ge(a(function(e, t = 0) {
        return Hn(this, e, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
      }, "writeBigInt64BE"));
      ...
      function $n(r, e, t, n, i) {
        return e = +e, t = t >>> 0, i || Gn(r, e, t, 4, 34028234663852886e22, -34028234663852886e22), Be.write(
          r,
          e,
          t,
          n,
      ...
      Qt("ERR_OUT_OF_RANGE", function(r, e, t) {
        ...
        return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? i = Un(String(t)) : typeof t == "bigint" && (i = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (i = Un(i)), i += "n"), n += ` It must be ${e}. Received ${i}`, n;
      }, RangeError);
      function Un(r) {
    ...
    var p = z(() => {
      ...
      w.subtle ?? (w.subtle = {});
      y = typeof globalThis.Buffer == "function" && typeof globalThis.Buffer.allocUnsafe == "function" ? globalThis.Buffer : Yn().Buffer, m = globalThis.process ?? {};
      m.env ?? (m.env = {});
      try {
        m.nextTick(() => {
        });
    ...
    var we = I((ih, Wt) => {
      ...
      var Xn = Number.isNaN || a(function(e) {
        return e !== e;
      }, "NumberIsNaN");
      function L() {
        L.init.call(this);
      ...
      Object.defineProperty(L, "defaultMaxListeners", { enumerable: true, get: a(function() {
        ...
        if (typeof r != "number" || r < 0 || Xn(r)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + r + ".");
        Jn = r;
      }, "set") });
      L.init = function() {
      ...
      L.prototype.setMaxListeners = a(
        function(e) {
          if (typeof e != "number" || e < 0 || Xn(e)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
      ...
      L.prototype.emit = a(function(e) {
        ...
        else for (var h = c.length, l = si(c, h), n = 0; n < h; ++n) Zn(
          l[n],
          this,
          t
        );
      ...
      function ti(r, e, t, n) {
        ...
        if (ct(t), s = r._events, s === void 0 ? (s = r._events = /* @__PURE__ */ Object.create(null), r._eventsCount = 0) : (s.newListener !== void 0 && (r.emit(
          ...
          t
        ) : o.push(t), i = ei(r), i > 0 && o.length > i && !o.warned) {
          o.warned = true;
      ...
      L.prototype.once = a(function(e, t) {
        return ct(t), this.on(e, ri(this, e, t)), this;
      }, "once");
      L.prototype.prependOnceListener = a(function(e, t) {
        return ct(t), this.prependListener(e, ri(
          this,
          e,
          t
        )), this;
      ...
      function ni(r, e, t) {
        ...
        if (n === void 0) return [];
        var i = n[e];
        return i === void 0 ? [] : typeof i == "function" ? t ? [i.listener || i] : [i] : t ? $o(i) : si(i, i.length);
      }
      a(ni, "_listeners");
      L.prototype.listeners = a(function(e) {
        return ni(this, e, true);
      }, "listeners");
      L.prototype.rawListeners = a(function(e) {
        return ni(this, e, false);
      }, "rawListeners");
      L.listenerCount = function(r, e) {
        return typeof r.listenerCount == "function" ? r.listenerCount(e) : ii.call(r, e);
      };
      L.prototype.listenerCount = ii;
      function ii(r) {
        var e = this._events;
        if (e !== void 0) {
          var t = e[r];
      ...
      function Vo(r, e) {
        return new Promise(
          function(t, n) {
            ...
            a(s, "resolver"), oi(r, e, s, { once: true }), e !== "error" && Ko(r, i, { once: true });
          }
        );
      }
      a(Vo, "once");
      function Ko(r, e, t) {
        typeof r.on == "function" && oi(r, "error", e, t);
      }
      a(
        Ko,
    ...
    function $e(r) {
      let e = 1779033703, t = 3144134277, n = 1013904242, i = 2773480762, s = 1359893119, o = 2600822924, u = 528734635, c = 1541459225, h = 0, l = 0, d = [
        ...
        for (let R = 16; R < 64; R++) {
          let $ = b(C[R - 15], 7) ^ b(C[R - 15], 18) ^ C[R - 15] >>> 3, le = b(C[R - 2], 17) ^ b(C[R - 2], 19) ^ C[R - 2] >>> 10;
          C[R] = C[R - 16] + $ + C[R - 7] + le | 0;
        }
        let A = e, g = t, P = n, K = i, k = s, j = o, ee = u, ae = c;
        for (let R = 0; R < 64; R++) {
          let $ = b(
            k,
            6
          ) ^ b(k, 11) ^ b(k, 25), le = k & j ^ ~k & ee, me = ae + $ + le + d[R] + C[R] | 0, Ee = b(A, 2) ^ b(A, 13) ^ b(A, 22), je = A & g ^ A & P ^ g & P, fe = Ee + je | 0;
          ae = ee, ee = j, j = k, k = K + me | 0, K = P, P = g, g = A, A = me + fe | 0;
        }
        e = e + A | 0, t = t + g | 0, n = n + P | 0, i = i + K | 0, s = s + k | 0, o = o + j | 0, u = u + ee | 0, c = c + ae | 0, l = 0;
      }, "process"), X = a((A) => {
    ...
    var Ht = {};
    re(Ht, { createHash: () => Zo, createHmac: () => Jo, randomBytes: () => Yo });
    function Yo(r) {
    ...
    var Kt = I((xh, hi) => {
      p();
      var ea = Vt();
      hi.exports = { create: a(function(r, e) {
        return { parse: a(
          function() {
            return ea.parse(r, e);
          },
    ...
    var pi = I((_h, fi) => {
      ...
      var ta = /(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/, ra = /^(\d{1,})-(\d{2})-(\d{2})( BC)?$/, na = /([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/, ia = /^-?infinity$/;
        ...
        return b != null ? (d = new Date(Date.UTC(
          ...
          h,
          l
        )), zt(i) && d.setUTCFullYear(i), b !== 0 && d.setTime(d.getTime() - b)) : (d = new Date(
          i,
          s,
          o,
          u,
    ...
    var wi = I((Bh, gi) => {
      ...
      var Yt = "([+-]?\\d+)", da = Yt + "\\s+years?", ya = Yt + "\\s+mons?", ma = Yt + "\\s+days?", ga = "([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?", wa = new RegExp([
        da,
        ya,
        ma,
        ga
      ...
      function xa(r) {
        ...
        return Object.keys(mi).reduce(function(n, i) {
          var s = mi[i], o = e[s];
    ...
    var Ti = I((kh, Ci) => {
      p();
      var Ke = Vt(), ze = Kt(), lt = pi(), Ei = wi(), vi = Si();
      function ft(r) {
        return a(function(t) {
          return t === null ? t : r(t);
        }, "nullAllowed");
      ...
      var Aa = a(function(r) {
        ...
        var e = ze.create(r, function(t) {
          return t !== null && (t = tr(t)), t;
        });
        return e.parse();
      }, "parsePointArray"), Jt = a(function(r) {
        if (!r)
          return null;
        var e = ze.create(r, function(t) {
        ...
        return e.parse();
      }, "parseFloatArray"), ie = a(function(r) {
        if (!r) return null;
        var e = ze.create(r);
        return e.parse();
      }, "parseStringArray"), Xt = a(function(r) {
        if (!r) return null;
        var e = ze.create(r, function(t) {
        ...
        return r ? Ke.parse(r, ft(vi)) : null;
      }, "parseByteAArray"), er = a(function(r) {
        return parseInt(
          r,
          10
        );
      }, "parseInteger"), Ai = a(function(r) {
        var e = String(r);
        return /^\d+$/.test(e) ? e : r;
      }, "parseBigInteger"), xi = a(
        function(r) {
        ...
        r(
          20,
          Ai
        ), r(21, er), r(23, er), r(26, er), r(700, parseFloat), r(701, parseFloat), r(16, _i), r(
          1082,
          lt
        ), r(1114, lt), r(1184, lt), r(600, tr), r(651, ie), r(718, Ia), r(1e3, Ea), r(1001, Ta), r(
          1005,
          Zt
        ), r(1007, Zt), r(1028, Zt), r(1016, _a), r(1017, Aa), r(1021, Jt), r(1022, Jt), r(1231, Jt), r(1014, ie), r(1015, ie), r(1008, ie), r(1009, ie), r(1040, ie), r(1041, ie), r(1115, Xt), r(
          1182,
          Xt
        ), r(1185, Xt), r(1186, Ei), r(1187, Ca), r(17, vi), r(114, JSON.parse.bind(JSON)), r(
          3802,
          JSON.parse.bind(JSON)
        ), r(199, xi), r(3807, xi), r(3907, ie), r(2951, ie), r(791, ie), r(
          1183,
          ie
        ), r(1270, ie);
      }, "init");
    ...
    var Mi = I((jh, Fi) => {
      p();
      var La = Pi(), F = a(function(r, e, t, n, i) {
      ...
      }, "parseNumeric"), Li = a(function(r, e) {
        var t = F(
          e,
          1
        ...
        r(20, La), r(21, Ra), r(23, Bi), r(
          26,
          Bi
        ), r(1700, Da), r(700, Fa), r(701, Ma), r(16, Ua), r(1114, Li.bind(null, false)), r(1184, Li.bind(
          null,
          true
    ...
    var Xe = I((Je) => {
      ...
      a(Ui, "noParse");
      function Wa(r, e) {
        return e = e || "text", Ze[e] && Ze[e][r] || Ui;
      }
      a(
        Wa,
        "getTypeParser"
    ...
    var et = I((Yh, rr) => {
      ...
      rr.exports.__defineSetter__("parseInt8", function(r) {
    ...
    var tt = I((Jh, Ni) => {
      ...
      a(za, "escapeElement");
      function Oi(r) {
        for (var e = "{", t = 0; t < r.length; t++) t > 0 && (e = e + ","), r[t] === null || typeof r[t] > "u" ? e = e + "NULL" : Array.isArray(r[t]) ? e = e + Oi(r[t]) : r[t] instanceof y ? e += "\\\\x" + r[t].toString("hex") : e += za(pt(r[t]));
        return e = e + "}", e;
      }
      a(Oi, "arrayString");
      var pt = a(function(r, e) {
        ...
        return r instanceof Date ? Ka.parseInputDatesAsUTC ? Ja(r) : Za(r) : Array.isArray(r) ? Oi(r) : typeof r == "object" ? Ya(r, e) : r.toString();
      }, "prepareValue");
      function Ya(r, e) {
      ...
      var nr = a(function(r) {
        ...
        var n = nr(e + r), i = nr(y.concat([y.from(n), t]));
        return "md5" + i;
      }, "postgresMd5PasswordHash");
      Ni.exports = { prepareValue: a(function(e) {
        return pt(
          e
        );
      }, "prepareValueWrapper"), normalizeQueryConfig: Xa, postgresMd5PasswordHash: eu, md5: nr };
    });
    var Hi = I((tl, Wi) => {
      "use strict";
      p();
      ...
      function tu(r) {
        ...
        let e = ir.randomBytes(18).toString("base64");
      ...
      function ru(r, e, t) {
        ...
        var i = y.from(n.salt, "base64"), s = uu(
          ...
          i,
          n.iteration
        ), o = ke(s, "Client Key"), u = au(o), c = "n=*,r=" + r.clientNonce, h = "r=" + n.nonce + ",s=" + n.salt + ",i=" + n.iteration, l = "c=biws,r=" + n.nonce, d = c + "," + h + "," + l, b = ke(u, d), C = ji(
          o,
          b
      ...
      function ou(r) {
        let t = Qi(r).get("v");
        if (t) {
          if (!qi(t)) throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature must be base64");
      ...
      a(ji, "xorBuffers");
      function au(r) {
        return ir.createHash(
          "sha256"
        ).update(r).digest();
      }
      a(au, "sha256");
      function ke(r, e) {
        return ir.createHmac(
          "sha256",
          r
        ).update(e).digest();
      }
      ...
      function uu(r, e, t) {
        ...
        ), i = n, s = 0; s < t - 1; s++) n = ke(r, n), i = ji(i, n);
        return i;
      }
      a(uu, "Hi");
      Wi.exports = { startSession: tu, continueSession: ru, finalizeSession: nu };
    });
    var sr = {};
    re(sr, { join: () => cu });
    function cu(...r) {
    ...
    var Yi = I((ll, zi) => {
      "use strict";
      p();
      var { Transform: fu } = (hr(), O(cr)), { StringDecoder: pu } = ($i(), O(Gi)), be = Symbol("last"), dt = Symbol("decoder");
      function du(r, e, t) {
        let n;
        if (this.overflow) {
          if (n = this[dt].write(r).split(this.matcher), n.length === 1) return t();
          n.shift(), this.overflow = false;
        } else this[be] += this[dt].write(r), n = this[be].split(this.matcher);
        this[be] = n.pop();
        for (let i = 0; i < n.length; i++) try {
          Ki(this, this.mapper(n[i]));
        } catch (s) {
          return t(
            s
          );
      ...
      a(du, "transform");
      function yu(r) {
        if (this[be] += this[dt].end(), this[be]) try {
          Ki(this, this.mapper(this[be]));
        } catch (e) {
          return r(e);
        }
        r();
      ...
      a(Vi, "noop");
      function mu(r, e, t) {
        switch (r = r || /\r?\n/, e = e || Vi, t = t || {}, arguments.length) {
          case 1:
            typeof r == "function" ? (e = r, r = /\r?\n/) : typeof r == "object" && !(r instanceof RegExp) && !r[Symbol.split] && (t = r, r = /\r?\n/);
            break;
          case 2:
            typeof r == "function" ? (t = e, e = r, r = /\r?\n/) : typeof e == "object" && (t = e, e = Vi);
        }
        t = Object.assign({}, t), t.autoDestroy = true, t.transform = du, t.flush = yu, t.readableObjectMode = true;
        let n = new fu(t);
        return n[be] = "", n[dt] = new pu("utf8"), n.matcher = r, n.mapper = e, n.maxLength = t.maxLength, n.skipOverflow = t.skipOverflow || false, n.overflow = false, n._destroy = function(i, s) {
    ...
    var Xi = I((dl, de) => {
      "use strict";
      p();
      var Zi = (or(), O(sr)), gu = (hr(), O(cr)).Stream, wu = Yi(), Ji = (Ge(), O(He)), bu = 5432, yt = m.platform === "win32", rt = m.stderr, Su = 56, xu = 7, Eu = 61440, vu = 32768;
      function _u(r) {
        return (r & Eu) == vu;
      }
      a(_u, "isRegFile");
      var Ue = [
        ...
        "user",
        "password"
      ], pr = Ue.length, Au = Ue[pr - 1];
      function dr() {
        var r = rt instanceof gu && rt.writable === true;
        if (r) {
          var e = Array.prototype.slice.call(arguments).concat(`
`);
          rt.write(Ji.format.apply(Ji, e));
        }
      }
      a(dr, "warn");
      Object.defineProperty(
      ...
      de.exports.usePgPass = function(r, e) {
        return Object.prototype.hasOwnProperty.call(m.env, "PGPASSWORD") ? false : yt ? true : (e = e || "<unkn>", _u(r.mode) ? r.mode & (Su | xu) ? (dr('WARNING: password file "%s" has group or world access; permissions should be u=rw (0600) or less', e), false) : true : (dr('WARNING: password file "%s" is not a plain file', e), false));
      };
      var Cu = de.exports.match = function(r, e) {
      ...
      de.exports.getPassword = function(r, e, t) {
        ...
        var o = a(function() {
          ...
          e.destroy(), dr("WARNING: error on reading file: %s", c), t(void 0);
        }, "onErr");
        e.on("error", u), i.on("data", s).on("end", o).on("error", u);
      };
      var Tu = de.exports.parseLine = function(r) {
        ...
        for (var e = "", t = "", n = 0, i = 0, s = 0, o = {}, u = false, c = a(function(l, d, b) {
          ...
          if (e = r.charAt(h + 1), t = r.charAt(h), u = n == pr - 1, u) {
            c(n, i);
            break;
          }
          h >= 0 && e == ":" && t !== "\\" && (c(n, i, h + 1), i = h + 2, n += 1);
        }
        return o = Object.keys(o).length === pr ? o : null, o;
      }, Iu = de.exports.isValidEntry = function(r) {
    ...
    var ts = I((wl, yr) => {
      "use strict";
      p();
      var gl = (or(), O(sr)), es = (ur(), O(ar)), mt = Xi();
      yr.exports = function(r, e) {
    ...
    var as = I((Cl, os) => {
      ...
      function br(r) {
        ...
        switch (s && s.charAt(0) === "/" && (s = s.slice(1) || null), t.database = s && decodeURI(s), (t.ssl === "true" || t.ssl === "1") && (t.ssl = true), t.ssl === "0" && (t.ssl = false), (t.sslcert || t.sslkey || t.sslrootcert || t.sslmode) && (t.ssl = {}), t.sslcert && (t.ssl.cert = wr.readFileSync(t.sslcert).toString()), t.sslkey && (t.ssl.key = wr.readFileSync(
          t.sslkey
        ).toString()), t.sslrootcert && (t.ssl.ca = wr.readFileSync(t.sslrootcert).toString()), t.sslmode) {
          case "disable": {
            t.ssl = false;
            break;
          }
    ...
    var bt = I((Pl, hs) => {
      "use strict";
      p();
      var Ru = (is(), O(ns)), cs = et(), us = as().parse, V = a(
        function(r, e, t) {
          return t === void 0 ? t = m.env["PG" + r.toUpperCase()] : t === false || (t = m.env[t]), e[r] || t || cs[r];
        },
        "val"
      ), Fu = a(function() {
        ...
        constructor(e) {
          e = typeof e == "string" ? us(e) : e || {}, e.connectionString && (e = Object.assign({}, e, us(e.connectionString))), this.user = V("user", e), this.database = V("database", e), this.database === void 0 && (this.database = this.user), this.port = parseInt(
            V("port", e),
            10
        ...
        getLibpqConnectionString(e) {
          var t = [];
          se(t, this, "user"), se(t, this, "password"), se(t, this, "port"), se(t, this, "application_name"), se(t, this, "fallback_application_name"), se(t, this, "connect_timeout"), se(
            t,
            this,
            "options"
          );
          var n = typeof this.ssl == "object" ? this.ssl : this.ssl ? { sslmode: this.ssl } : {};
          if (se(t, n, "sslmode"), se(t, n, "sslca"), se(t, n, "sslkey"), se(t, n, "sslcert"), se(t, n, "sslrootcert"), this.database && t.push("dbname=" + Oe(this.database)), this.replication && t.push("replication=" + Oe(this.replication)), this.host && t.push("host=" + Oe(this.host)), this.isDomainSocket) return e(null, t.join(" "));
    ...
    var ps = I((Rl, fs) => {
      "use strict";
      p();
      var Mu = Xe(), ls = /^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/, vr = class vr {
        constructor(e, t) {
          this.command = null, this.rowCount = null, this.oid = null, this.rows = [], this.fields = [], this._parsers = void 0, this._types = t, this.RowCtor = null, this.rowAsArray = e === "array", this.rowAsArray && (this.parseRow = this._parseRowAsArray);
        }
        addCommandComplete(e) {
          var t;
          e.text ? t = ls.exec(e.text) : t = ls.exec(e.command), t && (this.command = t[1], t[3] ? (this.oid = parseInt(t[2], 10), this.rowCount = parseInt(t[3], 10)) : t[2] && (this.rowCount = parseInt(
            t[2],
            10
          )));
        }
    ...
    var gs = I((Dl, ms) => {
      "use strict";
      p();
      var { EventEmitter: Du } = we(), ds = ps(), ys = tt(), Ar = class Ar extends Du {
        constructor(e, t, n) {
          super(), e = ys.normalizeQueryConfig(e, t, n), this.text = e.text, this.values = e.values, this.rows = e.rows, this.types = e.types, this.name = e.name, this.binary = e.binary, this.portal = e.portal || "", this.callback = e.callback, this._rowMode = e.rowMode, m.domain && e.callback && (this.callback = m.domain.bind(e.callback)), this._result = new ds(this._rowMode, this.types), this._results = this._result, this.isPreparedStatement = false, this._canceledDueToError = false, this._promise = null;
        }
        requiresPreparation() {
          return this.name || this.rows ? true : !this.text || !this.values ? false : this.values.length > 0;
        }
        _checkForMultirow() {
          this._result.command && (Array.isArray(this._results) || (this._results = [this._result]), this._result = new ds(
            this._rowMode,
            this.types
        ...
        prepare(e) {
          ...
          try {
            e.bind({ portal: this.portal, statement: this.name, values: this.values, binary: this.binary, valueMapper: ys.prepareValue });
          } catch (t) {
    ...
    var St = z(() => {
      ...
      bs = Ie(we(), 1);
      a(ku, "isIP");
      ws = /^[^.]+\./, v = class v2 extends bs.EventEmitter {
        constructor() {
          super(...arguments);
          _(this, "opts", {});
      ...
      a(v, "Socket"), _(v, "defaults", {
        ...
        fetchEndpoint: a((t, n, i) => {
          let s;
          return i?.jwtAuth ? s = t.replace(ws, "apiauth.") : s = t.replace(ws, "api."), "https://" + s + "/sql";
        }, "fetchEndpoint"),
    ...
    var en = I((T) => {
      ...
      a(Hr, "RowDescriptionMessage");
      var Br = Hr;
      T.RowDescriptionMessage = Br;
      var Gr = class Gr {
        constructor(e, t) {
          this.length = e, this.parameterCount = t, this.name = "parameterDescription", this.dataTypeIDs = new Array(this.parameterCount);
        }
      };
      a(Gr, "ParameterDescriptionMessage");
      var Lr = Gr;
      T.ParameterDescriptionMessage = Lr;
      var $r = class $r {
        constructor(e, t, n) {
          this.length = e, this.parameterName = t, this.parameterValue = n, this.name = "parameterStatus";
        }
      };
      a($r, "ParameterStatusMessage");
      var Rr = $r;
      T.ParameterStatusMessage = Rr;
      var Vr = class Vr {
        constructor(e, t) {
          this.length = e, this.salt = t, this.name = "authenticationMD5Password";
        }
      };
      a(Vr, "AuthenticationMD5Password");
      var Fr = Vr;
      T.AuthenticationMD5Password = Fr;
      var Kr = class Kr {
        constructor(e, t, n) {
      ...
      var Mr = Kr;
      T.BackendKeyDataMessage = Mr;
      var zr = class zr {
        constructor(e, t, n, i) {
          this.length = e, this.processId = t, this.channel = n, this.payload = i, this.name = "notification";
        }
      };
      a(zr, "NotificationResponseMessage");
      var Dr = zr;
      T.NotificationResponseMessage = Dr;
      var Yr = class Yr {
        constructor(e, t) {
          this.length = e, this.status = t, this.name = "readyForQuery";
        }
      };
      a(Yr, "ReadyForQueryMessage");
      var kr = Yr;
      T.ReadyForQueryMessage = kr;
      var Zr = class Zr {
        constructor(e, t) {
    ...
    var vs = I((vt) => {
      ...
      vt.serialize = void 0;
      var nn = xs(), M = new nn.Writer(), Uu = a((r) => {
        ...
        return new nn.Writer().addInt32(t).add(e).flush();
      }, "startup"), Ou = a(() => {
        ...
        return M.flush(80);
      }, "parse"), Ne = new nn.Writer(), Hu = a(function(r, e) {
        ...
        "cstringMessage"
      ), zu = M.addCString("P").flush(68), Yu = M.addCString("S").flush(68), Zu = a((r) => r.name ? sn(68, `${r.type}${r.name || ""}`) : r.type === "P" ? zu : Yu, "describe"), Ju = a(
        (r) => {
          let e = `${r.type}${r.name || ""}`;
          return sn(67, e);
        },
        ...
        100
      ), "copyData"), ec = a((r) => sn(102, r), "copyFail"), Et = a((r) => y.from([r, 0, 0, 0, 4]), "codeOnlyBuffer"), tc = Et(72), rc = Et(83), nc = Et(88), ic = Et(99), sc = {
        startup: Uu,
        password: Nu,
        requestSsl: Ou,
    ...
    var _s = I((_t) => {
      ...
      var oc = y.allocUnsafe(0), an = class an {
        constructor(e = 0) {
    ...
    var Ts = I((At) => {
      ...
      At.Parser = void 0;
      var D = en(), ac = _s(), un = 1, uc = 4, As = un + uc, Cs = y.allocUnsafe(0), hn = class hn {
        constructor(e) {
          if (this.buffer = Cs, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ac.BufferReader(), e?.mode === "binary") throw new Error("Binary mode not supported yet");
        ...
        parse(e, t) {
          ...
          for (; i + As <= n; ) {
            ...
            if (u + i <= n) {
              let c = this.handlePacket(i + As, s, o, this.buffer);
              t(c), i += u;
            } else
              break;
          }
          i === n ? (this.buffer = Cs, this.bufferLength = 0, this.bufferOffset = 0) : (this.bufferLength = n - i, this.bufferOffset = i);
        }
        mergeBuffer(e) {
    ...
    var dn = I((af, Rs) => {
      "use strict";
      p();
      var Bs = (St(), O(Ss)), dc = we().EventEmitter, {
        parse: yc,
        serialize: q
      } = ln(), Ls = q.flush(), mc = q.sync(), gc = q.end(), pn = class pn extends dc {
        constructor(e) {
          super(), e = e || {}, this.stream = e.stream || new Bs.Socket(), this._keepAlive = e.keepAlive, this._keepAliveInitialDelayMillis = e.keepAliveInitialDelayMillis, this.lastBuffer = false, this.parsedStatements = {}, this.ssl = e.ssl || false, this._ending = false, this._emitMessage = false;
          var t = this;
        ...
        connect(e, t) {
          ...
          this.stream.once("data", function(s) {
            ...
            n.ssl !== true && (Object.assign(
              c,
              n.ssl
            ), "key" in n.ssl && (c.key = n.ssl.key)), Bs.isIP(t) === 0 && (c.servername = t);
            try {
        ...
        flush() {
          this.stream.writable && this.stream.write(Ls);
        }
        sync() {
          this._ending = true, this._send(Ls), this._send(mc);
        }
        ref() {
          this.stream.ref();
        }
    ...
    var Ds = I((lf, Ms) => {
      "use strict";
      p();
      var wc = we().EventEmitter, hf = (Ge(), O(He)), bc = tt(), yn = Hi(), Sc = ts(), xc = wt(), Ec = bt(), Fs = gs(), vc = et(), _c = dn(), mn = class mn extends wc {
        constructor(e) {
        ...
        query(e, t, n) {
          ...
          return typeof e.submit == "function" ? (o = e.query_timeout || this.connectionParameters.query_timeout, s = i = e, typeof t == "function" && (i.callback = i.callback || t)) : (o = this.connectionParameters.query_timeout, i = new Fs(
            e,
            t,
            n
    ...
    var Ns = I((df, Os) => {
      "use strict";
      p();
      var Ac = we().EventEmitter, ks = a(function() {
      }, "NOOP"), Us = a(
        (r, e) => {
          let t = r.findIndex(e);
      ...
      var xn = class xn extends Ac {
        ...
        _remove(e) {
          let t = Us(this._idle, (n) => n.client === e);
        ...
        _acquireClient(e, t, n, i) {
          i && this.emit("connect", e), this.emit("acquire", e), e.release = this._releaseOnce(e, n), e.removeListener("error", n), t.timedOut ? i && this.options.verify ? this.options.verify(
            ...
            if (s) return e.release(s), t.callback(s, void 0, ks);
        ...
        _release(e, t, n) {
          ...
          }, this.options.idleTimeoutMillis), this.options.allowExitOnIdle && s.unref()), this.options.allowExitOnIdle && e.unref(), this._idle.push(new gn(e, t, s)), this._pulseQueue();
        }
        query(e, t, n) {
    ...
    var Gs = I((bf, Hs) => {
      "use strict";
      p();
      var Ws = we().EventEmitter, Bc = (Ge(), O(He)), En = tt(), Qe = Hs.exports = function(r, e, t) {
        Ws.call(this), r = En.normalizeQueryConfig(r, e, t), this.text = r.text, this.values = r.values, this.name = r.name, this.callback = r.callback, this.state = "new", this._arrayMode = r.rowMode === "array", this._emitRowEvents = false, this.on("newListener", function(n) {
    ...
    var zs = I((vf, Ks) => {
      "use strict";
      p();
      var Rc = (Qs(), O(qs)), Fc = wt(), Ef = js(), $s = we().EventEmitter, Mc = (Ge(), O(He)), Dc = bt(), Vs = Gs(), J = Ks.exports = function(r) {
        $s.call(this), r = r || {}, this._Promise = r.Promise || S.Promise, this._types = new Fc(r.types), this.native = new Rc({ types: this._types }), this._queryQueue = [], this._ending = false, this._connecting = false, this._connected = false, this._queryable = true;
      ...
      J.prototype.query = function(r, e, t) {
        ...
        else if (s = this.connectionParameters.query_timeout, n = new Vs(r, e, t), !n.callback) {
          let c, h;
    ...
    var It = I((If, nt) => {
      "use strict";
      p();
      var kc = Ds(), Uc = et(), Oc = dn(), Nc = Ns(), { DatabaseError: qc } = ln(), Qc = a((r) => {
        var e;
      ...
      typeof m.env.NODE_PG_FORCE_NATIVE < "u" ? nt.exports = new _n(vn()) : (nt.exports = new _n(kc), Object.defineProperty(nt.exports, "native", { configurable: true, enumerable: false, get() {
        var r = null;
        try {
          r = new _n(vn());
        } catch (e) {
    ...
    re(Vc, {
      Client: () => Bt,
      ClientBase: () => oe.ClientBase,
      Connection: () => oe.Connection,
      DatabaseError: () => oe.DatabaseError,
      NeonDbError: () => he,
      Pool: () => Cn,
      Query: () => oe.Query,
      defaults: () => oe.defaults,
      neon: () => An,
      neonConfig: () => Se,
      types: () => oe.types
    });
    module2.exports = O(Vc);
    p();
    var Lt = Ie(It());
    St();
    p();
    ...
    function An(r, {
      ...
      function X(A, ...g) {
        ...
        g = g.map((j) => jc((0, Xs.prepareValue)(j)));
        let k = {
          query: P,
          params: g
        };
        return u && u(k), Hc(ye, k, K);
      }
      ...
      async function ye(A, g, P) {
        let { fetchEndpoint: K, fetchFunction: k } = Se, j = Array.isArray(A) ? { queries: A } : A, ee = n ?? {}, ae = e ?? false, R = t ?? false, $ = i, le = s, me = o;
        P !== void 0 && (P.fetchOptions !== void 0 && (ee = {
          ...ee,
          ...P.fetchOptions
        }), P.arrayMode !== void 0 && (ae = P.arrayMode), P.fullResults !== void 0 && (R = P.fullResults), P.isolationLevel !== void 0 && ($ = P.isolationLevel), P.readOnly !== void 0 && (le = P.readOnly), P.deferrable !== void 0 && (me = P.deferrable)), g !== void 0 && !Array.isArray(
          g
        ) && g.fetchOptions !== void 0 && (ee = { ...ee, ...g.fetchOptions });
        let Ee = h;
        !Array.isArray(
          g
        ) && g?.authToken !== void 0 && (Ee = g.authToken);
        let je = typeof K == "function" ? K(C, B, { jwtAuth: Ee !== void 0 }) : K, fe = { "Neon-Connection-String": r, "Neon-Raw-Text-Output": "true", "Neon-Array-Mode": "true" }, it = await Gc(Ee);
        it && (fe.Authorization = `Bearer ${it}`), Array.isArray(
          A
        ) && ($ !== void 0 && (fe["Neon-Batch-Isolation-Level"] = $), le !== void 0 && (fe["Neon-Batch-Read-Only"] = String(le)), me !== void 0 && (fe["Neon-Batch-Deferrable"] = String(me)));
        let te;
        try {
          te = await (k ?? fetch)(je, {
            method: "POST",
          ...
          let H = new he(`Error connecting to database: ${W.message}`);
        ...
        if (te.ok) {
          ...
          if (Array.isArray(A)) {
            let H = W.results;
            if (!Array.isArray(H)) throw new he("Neon internal error: unexpected result format");
            return H.map((Ce, ve) => {
              let Rt = g[ve] ?? {}, ro = Rt.arrayMode ?? ae, no = Rt.fullResults ?? R;
              return Js(Ce, {
                arrayMode: ro,
                fullResults: no,
                parameterizedQuery: A[ve],
                resultCallback: c,
                types: Rt.types
              });
            });
          } else {
            let H = g ?? {}, Ce = H.arrayMode ?? ae, ve = H.fullResults ?? R;
            return Js(
              W,
              { arrayMode: Ce, fullResults: ve, parameterizedQuery: A, resultCallback: c, types: H.types }
            );
          }
        } else {
          let { status: W } = te;
          if (W === 400) {
            let H = await te.json(), Ce = new he(H.message);
            for (let ve of Wc)
              Ce[ve] = H[ve] ?? void 0;
            throw Ce;
          } else {
            let H = await te.text();
            throw new he(`Server error (HTTP status ${W}): ${H}`);
          }
        }
      }
    ...
    a(Js, "processQueryResult");
    async function Gc(r) {
      if (typeof r == "string") return r;
      if (typeof r == "function") try {
        return await Promise.resolve(r());
      } catch (e) {
        let t = new he("Error getting auth token.");
        throw e instanceof Error && (t = new he(`Error getting auth token: ${e.message}`)), t;
      }
    }
    a(Gc, "getAuthToken");
    var to = Ie(bt());
    var oe = Ie(It());
    var Tn = class Tn extends Lt.Client {
      constructor(t) {
        super(t);
        this.config = t;
      }
      ...
      async _handleAuthSASLContinue(t) {
        ...
        for (var ye = 0; ye < l - 1; ye++) Q = new Uint8Array(await w.subtle.sign(
          "HMAC",
          B,
          Q
        ...
        let A = X, g = await w.subtle.importKey(
          ...
          "SHA-256",
          P
        ), k = "n=*,r=" + n.clientNonce, j = "r=" + u + ",s=" + c + ",i=" + l, ee = "c=biws,r=" + u, ae = k + "," + j + "," + ee, R = await w.subtle.importKey(
          "raw",
          K,
          { name: "HMAC", hash: { name: "SHA-256" } },
          false,
        ...
        var $ = new Uint8Array(await w.subtle.sign("HMAC", R, b.encode(ae))), le = y.from(P.map((te, W) => P[W] ^ $[W])), me = le.toString("base64");
        let Ee = await w.subtle.importKey(
          "raw",
          A,
          { name: "HMAC", hash: { name: "SHA-256" } },
          false,
          ...
          Ee,
          b.encode("Server Key")
        ), fe = await w.subtle.importKey("raw", je, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]);
        var it = y.from(await w.subtle.sign(
          "HMAC",
          fe,
          b.encode(ae)
        ));
        n.message = "SASLResponse", n.serverSignature = it.toString("base64"), n.response = ee + ",p=" + me, this.connection.sendSCRAMClientFinalMessage(this.saslSession.response);
      }
    };
    a(Tn, "NeonClient");
    var Bt = Tn;
    ...
    a($c, "promisify");
    var In = class In extends Lt.Pool {
      constructor() {
        super(...arguments);
        _(this, "Client", Bt);
      ...
      query(t, n, i) {
        ...
        try {
          ...
          An(h, { fullResults: true, arrayMode: t.rowMode === "array" })(l, d, { types: t.types ?? this.options?.types }).then((C) => i(void 0, C)).catch((C) => i(
            C
          ));
        } catch (o) {
          i(o);
...
// node_modules/@netlify/neon/dist/index.js
var require_dist = __commonJS({
  "node_modules/@netlify/neon/dist/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.neon = neon2;
    var serverless_1 = require_serverless();
    function neon2(connStrOrOptions, maybeOptions) {
      ...
      if (connectionString === void 0 && process.env.NETLIFY_DATABASE_URL === void 0) {
...
var add_movimientos_exports = {};
__export(add_movimientos_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(add_movimientos_exports);
var import_neon = __toESM(require_dist(), 1);
...
@neondatabase/serverless/index.js:
  ...
  *)
*/
//# sourceMappingURL=add-movimientos.js.map
